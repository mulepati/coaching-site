  ...
  return (
    <div className="space-y-6">
      <section className="relative overflow-hidden rounded-[2.5rem] border border-ink/12 bg-paper/44 px-6 py-10 dark:border-white/10 dark:bg-dark-surface md:px-8 md:py-12">
        <div className="absolute left-8 top-8 h-24 w-24 rounded-full bg-primary/12 blur-3xl dark:bg-dark-accent/8" />
      ...
      <section className="relative overflow-hidden rounded-[2rem] border border-primary/16 bg-primary/8 px-6 py-9 text-center dark:border-dark-accent/16 dark:bg-dark-accent/8 md:px-8">
        <div className="absolute left-10 top-6 h-16 w-16 rounded-full bg-primary/10 blur-2xl dark:bg-dark-accent/8" />
        ...
        <div className="relative mx-auto max-w-2xl space-y-4">
          ...
          <p className="text-base leading-8 text-ink/74 dark:text-dark-text/74">
            The first coaching session is free. Bring something real, and we
            can work with it together.
          </p>
          <Link
            href={bookingUrl}
            className="inline-flex rounded-full bg-primary px-5 py-3 text-sm font-semibold text-paper hover:-translate-y-0.5 hover:bg-primary/92 dark:bg-dark-accent dark:text-dark-bg dark:hover:bg-dark-accent/90"
          >
            Book a free session
          </Link>
        </div>
