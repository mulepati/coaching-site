...
function FacilitationVisual() {
  return (
    <div className="relative flex h-full min-h-[18rem] overflow-hidden rounded-[1.5rem] border border-ink/10 bg-gradient-to-br from-paper/68 via-paper/44 to-secondary/14 p-5">
      ...
      <div className="relative grid w-full gap-3 md:grid-cols-[1.15fr_0.85fr]">
        <div className="rounded-[1.25rem] border border-ink/10 bg-paper/72 p-4">
        ...
        <div className="grid gap-3">
          <div className="rounded-[1.25rem] border border-primary/12 bg-primary/8 p-4">
            <p className="text-sm font-semibold text-ink">Presence</p>
          </div>
          <div className="rounded-[1.25rem] border border-secondary/18 bg-secondary/10 p-4">
            <p className="text-sm font-semibold text-ink">Clarity</p>
          </div>
          <div className="rounded-[1.25rem] border border-ink/10 bg-paper/60 p-4">
            <p className="text-sm font-semibold text-ink">Participation</p>
          </div>
        </div>
      </div>
    </div>
...
function ImageVisual({
  ...
  return (
    <div className="relative flex h-full min-h-[18rem] overflow-hidden rounded-[1.5rem] border border-ink/10 bg-gradient-to-br from-paper/62 via-paper/42 to-primary/10 p-5">
      <div className="absolute left-8 top-6 h-16 w-16 rounded-full bg-primary/14 blur-2xl" />
      <div className="absolute bottom-6 right-6 h-20 w-20 rounded-full bg-secondary/16 blur-3xl" />
      <div className="relative flex h-full w-full items-center justify-center rounded-[1.25rem] border border-ink/10 bg-paper/46 p-4">
        <img
          src={imageSrc}
          alt={imageAlt}
      ...
      >
        ...
        <div className="space-y-5">
          <div className="space-y-4">
            ...
            <p className="max-w-xl text-base leading-8 text-ink/74">
              {description}
            </p>
          </div>

          {overviewTitle && overviewItems && overviewItems.length > 0 ? (
            <div className="rounded-[1.5rem] border border-ink/10 bg-paper/44 p-5">
